<?php
/**
 * @package Done_B2bLogin
 * @copyright donecommerce.com ${date}
 * @author durga
 */
namespace Done\B2bLogin\Observer;
...
class ForceLoginObserver implements ObserverInterface
{
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        $forced_login_status = $this->scopeConfig->getValue(
            'b2blogin/parameters/status',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
        $forced_login_access = $this->scopeConfig->getValue(
            'b2blogin/parameters/access_to_website',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
